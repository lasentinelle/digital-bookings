  ...
  <main class="flex-1 bg-white">
    <div class="px-12 py-10">
      <div class="flex items-center gap-4">
        ...
        <h1 class="text-2xl font-semibold text-gray-900">Add Placement</h1>
      </div>
        ...
        <div>
          ...
          <div class="mt-2">
            <textarea name="description" id="description" rows="4"
              class="block w-full rounded-lg border @error('description') border-red-500 @else border-gray-200 @enderror bg-white px-4 py-2.5 text-gray-900 shadow-sm placeholder:text-gray-400 focus:border-gray-300 focus:outline-none focus:ring-4 focus:ring-gray-100">{{ old('description') }}</textarea>
          </div>
          @error('description')
            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
          @enderror
