  ...
  <main class="flex-1 bg-white">
    <div class="px-12 py-10">
      <div class="flex items-center gap-4">
        ...
        <h1 class="text-2xl font-semibold text-gray-900">Add Agency</h1>
      </div>
      <div class="mt-6 h-px w-full bg-gray-100"></div>

      <form action="{{ route('agencies.store') }}" method="POST" enctype="multipart/form-data" class="mt-8 max-w-2xl space-y-8">
        @csrf
        ...
        <div class="space-y-6">
          ...
          <div>
            ...
            <p class="mt-1 text-xs text-gray-500">JPEG or PNG, max 1 MB.</p>
            @error('company_logo')
          ...
          <div class="grid grid-cols-2 gap-6">
            <div>
              ...
              <div class="mt-2">
                <input type="text" name="brn" id="brn" value="{{ old('brn') }}" required
          ...
          <div class="grid grid-cols-2 gap-6">
            <div>
              ...
              <div class="mt-2">
                <input name="vat_number" id="vat_number" value="{{ old('vat_number') }}"
        ...
        <div class="space-y-6">
          ...
          <div class="grid grid-cols-2 gap-6">
            <div>
              ...
              <div class="mt-2">
                <input name="commission_amount" id="commission_amount" value="{{ old('commission_amount') }}" min="0"
              ...
              <div class="mt-2">
                <select name="commission_type" id="commission_type"
                  ...
                  @foreach($commissionTypes as $type)
                    <option value="{{ $type->value }}" {{ old('commission_type') === $type->value ? 'selected' : '' }}>{{ $type->value }}</option>
                  @endforeach
                </select>
              </div>
