...
class PlacementSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $placements = [
            ...
            ['name' => 'Facebook Boost', 'price' => 0, 'type' => PlacementType::SocialMedia, 'platform_id' => $lexpress->id],
            ...
            ['name' => 'Facebook Boost', 'price' => 0, 'type' => PlacementType::SocialMedia, 'platform_id' => $fivePlus->id],
